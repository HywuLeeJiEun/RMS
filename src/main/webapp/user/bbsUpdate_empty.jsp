			...
			<div class="row">
					...
					<table class="table" id="bbsTable" style="text-align: center; border: 1px solid #dddddd; cellpadding:50px;" >
						...
						<tbody id="tbody">
							<tr class="ui-state-default ui-state-disabled">
									...
									<td colspan="1"></td>
									<td colspan="3">  주간보고 제출일 <input type="date" max="9999-12-31" required style="width:80%; margin-left:20px" class="form-control" placeholder="주간보고 날짜(월 일)" name="bbsDeadline" id="rms_dl" value="<%= date %>"></td>
							</tr>
									<tr class="ui-state-default ui-state-disabled">
									...
									<tr>
										 <td>
											 ...
											 <div style="float:left">
											 <textarea class="textarea con" wrap="hard" id="bbsContent0" maxlength="500" required style="height:45px;width:290px; border:none; resize:none " placeholder="업무내용" name="bbsContent0"></textarea>
											 </div>
										 </td>
				...
				<tbody id="tbody">
							...
							<td><div style="float:left">
								...
								<div style="float:left">
								<textarea wrap="hard" class="textarea ncon" maxlength="500" id="bbsNContent0" required style="height:45px;width:290px; resize:none; border:none; " placeholder="업무내용" name="bbsNContent0"></textarea>
							</div> </td>
	...
	work = work.split(',');		
		...
		function addRow() {
			...
			for(var count=0; count < work.length; count++) {
	            ...
	            innerHtml += '  <td><textarea class="textarea end" id="bbsEnd'+c+'" style="height:45px; resize:none; width:70px; border:none; text-align:center" maxlength="5" data-toggle="tooltip" data-placement="bottom" title="미입력시 [보류]로 표시됩니다."  placeholder="MM/dd" name="bbsEnd'+c+'" ></textarea></td>'; 
	            innerHtml += '    <td>';
