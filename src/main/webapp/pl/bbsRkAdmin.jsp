...
<body>
					...
					<li class="dropdown ">
						...
						%>
							...
							<ul class="dropdown-menu">
								...
								<li class="active" id="summary_nav"><a href="/RMS/pl/summaryRkSign.jsp">조회 및 출력</a></li>
							</ul>
							</li>
						<%
							}
	...
	<form method="post" action="/RMS/admin/action/bbsRkAdminUpdate.jsp" id="bbsRk">
		...
		<% if(etlist.get(0).getSum_sign().equals("승인") || etlist.get(0).getSum_sign().equals("마감")) {  //승인이나 마감 상태시에만 pptx로 출력 가능!%>
				<button type="button" class="btn btn-primary pull-right" style="width:50px; text-align:center; align:center; margin-left:20px" onClick="location.href='/RMS/pl/summaryRkSign.jsp'">목록</button> 
